...
import { extractDocumentText, analyzeDocumentWithClaude, SUPPORTED_DOCUMENT_EXTENSIONS, } from '../services/documentExtract.js';
...
const upload = multer({
    ...
    fileFilter: (_req, file, cb) => {
        ...
        const ok = SUPPORTED_DOCUMENT_EXTENSIONS.includes(ext);
        if (!ok) {
